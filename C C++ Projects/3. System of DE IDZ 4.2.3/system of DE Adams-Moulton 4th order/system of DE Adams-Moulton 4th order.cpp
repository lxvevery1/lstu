...
double cos_func(double xi, double y1i, double y2i, double y3i, double h)
{
	...
	k1 = 9 * f1(xi, y1i, y2i, y3i);
	k2 = 37 * f1(xi, y1i, y2i, y3i);
	k3 = 59 * f1(xi, y1i, y2i, y3i);
	k4 = 55 * f1(xi, y1i, y2i, y3i);
	k = (h / 24) * (k4 - k3 + k2 - k1);
	return k;
}
...
{
	double k1, k2, k3, k4, k;
	k1 = 9 * f2(xi, y1i, y2i, y3i);
	k2 = 37 * f2(xi, y1i, y2i, y3i);
	k3 = 59 * f2(xi, y1i, y2i, y3i);
	k4 = 55 * f2(xi, y1i, y2i, y3i);
	k = (h / 24) * (k4 - k3 + k2 - k1);
	return k;
}
...
{
	double k1, k2, k3, k4, k;
	k1 = 9 * f3(xi, y1i, y2i, y3i);
	k2 = 37 * f3(xi, y1i, y2i, y3i);
	k3 = 59 * f3(xi, y1i, y2i, y3i);
	k4 = 55 * f3(xi, y1i, y2i, y3i);
	k = (h / 24) * (k4 - k3 + k2 - k1);
	return k;
}
