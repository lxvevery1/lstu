	...
	public: System::Void anyField_Click(System::Object^ sender, System::EventArgs^ e)
	{
		if (nowFigure->Length != 0)
		{
			...
			if (nowFigure == L"whiteKing")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\whiteKing.png");
			else if (nowFigure == L"blackKing")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\blackKing.png");
			else if (nowFigure == L"whiteQueen")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\whiteQueen.png");
			else if (nowFigure == L"blackQueen")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\blackQueen.png");
			else if (nowFigure == L"whiteRoof")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\whiteRoof.png");
			else if (nowFigure == L"blackRoof")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\blackRoof.png");
			else if (nowFigure == L"whiteBishop")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\whiteBishop.png");
			else if (nowFigure == L"blackBishop")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\blackBishop.png");
			else if (nowFigure == L"whiteKnight")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\whiteKnight.png");
			else if (nowFigure == L"blackKnight")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\blackKnight.png");
			else if (nowFigure == L"whitePawn")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\whitePawn.png");
			else if (nowFigure == L"blackPawn")
				pictureBox->BackgroundImage = Image::FromFile("C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\blackPawn.png");
		...
		for each (Figure ^ figure in figures)
		{
...

			{
				if (dynamic_cast<PictureBox^>(x) != nullptr)
				{
					...
					{
						auto filepath = L"C:\\Users\\lxve_every1\\source\\repos\\Project1\\Project1\\" + figure->color + figure->name + L".png";
