...
S resul[8000];  //выделение пам€ти с запасом
...
int main()
{
    ...
    printf("\n\n");
    printf("               ----------------ќтсортированные ленты----------------\n");
    for (i = 0; i < sqrt(N); i++) 
    {
        sort(str, i, sqrt(N));
        printf("\n");
    }
    printf("               ---------------- онечные данные----------------\n");

    char stroka1[9] = { 0,0,0,0,0,0,0,0,0 }, t = 0;
    while (t < N)
    {
        int max = 0;
        for (i = 0; i < N; i++)
