...
int main()
{
	...
	blockList_add_end(&l, new record{ 0, {2,32}, {'C'}, 2.0 });
	blockList_add_end(&l, new record{ 3, {3,33}, {'D'}, 3.0 });
	blockList_add_end(&l, new record{ 4, {4,34}, {'E','F'}, 4.0 });
	blockList_add_end(&l, new record{ 5, {5,36}, {'G','H'}, 5.2 });
	blockList_add_end(&l, new record{ 6, {6,36}, {'I'}, 6.1 });
	blockList_add_end(&l, new record{ 7, {4, 67, 76,45}, {'D', 'Z', 'x', 'C'}, 5.3 });
	blockList_add_end(&l, new record{ 11, {4,34}, {'E','F'}, 4.0 });
	blockList_add_end(&l, new record{ 9, {5,35}, {'G','H'}, 5.1 });
	//block 1
	blockList_add_end(&l, new record{ 10, {4,34}, {'E','F'}, 4.0 });
	blockList_add_end(&l, new record{ 11, {5,35}, {'G','H'}, 5.0 });
	blockList_add_end(&l, new record{ 7, {4, 67, 76,45}, {'D', 'Z', 'x', 'C'}, 5.3 });
	blockList_add_end(&l, new record{ 11, {4,34}, {'E','F'}, 4.0 });
	blockList_add_end(&l, new record{ 9, {5,35}, {'G','H'}, 5.1 });
	blockList_add_end(&l, new record{ 7, {4, 67, 76,45}, {'D', 'Z', 'x', 'C'}, 5.3 });
	...
	blockList_add_end(&l, new record{ 9, {5,35}, {'G','H'}, 5.1 });
	blockList_add_end(&l, new record{ 9, {5,35}, {'G','H'}, 5.1 });
	blockList_add_end(&l, new record{ 0, {4, 67, 76,45}, {'D', 'Z', 'x', 'C'}, 5.3 });

	//blockList_add_begin(&l, new record{ 5, {5, 66, 56, 45}, {'B', 'e', 'g', 'i', 'n', 'n', 'i', 'n', 'g'}, 5.5 });
	//blockList_add_custom(&l, new record{ 7, {11, 69}, {'C', 'U', 'S', 'T'}, 5.5 }, 1, 0);

	//blockList_add_custom(&l, new record{ 69, {11, 69}, {'C', 'U', 'S', 'T'}, 5.5 }, 0, 0);
	//blockList_delete_custom(&l, 1, 1);
	//blockList_Just_Print(&l);
	blockList_print(&l);
	Search_record(&l, new record{ 0 });
